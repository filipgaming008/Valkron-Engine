...
namespace Valkron {
    ...
    static void applyRetroImGuiStyle() {
        ...
        colors[ImGuiCol_Border] = ImVec4(0.24f, 0.29f, 0.36f, 1.00f);
        colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
        colors[ImGuiCol_FrameBg] = ImVec4(0.12f, 0.14f, 0.18f, 1.00f);
        colors[ImGuiCol_FrameBgHovered] = ImVec4(0.17f, 0.21f, 0.27f, 1.00f);
        colors[ImGuiCol_FrameBgActive] = ImVec4(0.20f, 0.25f, 0.32f, 1.00f);
        colors[ImGuiCol_TitleBg] = ImVec4(0.05f, 0.06f, 0.09f, 1.00f);
        colors[ImGuiCol_TitleBgActive] = ImVec4(0.08f, 0.11f, 0.16f, 1.00f);
        colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.05f, 0.06f, 0.09f, 0.90f);
