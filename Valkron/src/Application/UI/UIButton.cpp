...
UIButton::UIButton(const glm::vec2& position, const glm::vec2& size, const glm::vec4& color, const std::string& label,
                   const std::string& debugName, const std::array<glm::vec2, 4>& texCoords)
    : m_color(color), m_texCoords(texCoords), m_label(label), m_debugName(debugName) {
    m_position = position;
    m_size = size;
