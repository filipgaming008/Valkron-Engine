...
#define LOG_INFO(msg) std::cout << "\033[32m[INFO] [" << VALKRON_LOG_SOURCE << "] " << (msg) << "\033[0m" << std::endl

#define LOG_WARN(msg) std::cout << "\033[33m[WARN] [" << VALKRON_LOG_SOURCE << "] " << (msg) << "\033[0m" << std::endl

#define LOG_ERROR(msg) std::cerr << "\033[31m[ERROR] [" << VALKRON_LOG_SOURCE << "] " << (msg) << "\033[0m" << std::endl

#define LOG_DEBUG(msg) std::cout << "\033[34m[DEBUG] [" << VALKRON_LOG_SOURCE << "] " << (msg) << "\033[0m" << std::endl
